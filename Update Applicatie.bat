...
set URL=https://github.com/FluffyAsianKid/LNR2.0-Datapipeline_release/raw/main/LNR2.0-Datapipeline/LNR2.0-Datapipeline.exe

REM Name of the .exe file to be updated
set EXE_NAME="LNR2.0 Datapipeline.exe"
...
if exist %TEMP_EXE% (
    ...
    echo Update complete.
     ...
     REM Clean up log file only after successful update
    del "%LOG_FILE%"
) else (
